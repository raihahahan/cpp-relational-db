...
const std::vector<ColumnInfo> ATTR_CATALOG_SCHEMA = {
    ...
    {DB_ATTRIBUTES_TABLE_ID, "col_name", TEXT_TYPE, 2},
    {DB_ATTRIBUTES_TABLE_ID, "type_id", INT_TYPE, 3},
    {DB_ATTRIBUTES_TABLE_ID, "ordinal_position", INT_TYPE, 4}
};

const std::vector<ColumnInfo> TYPES_CATALOG_SCHEMA = {
    {DB_TYPES_TABLE_ID, "type_id", INT_TYPE, 1},
    {DB_TYPES_TABLE_ID, "size", INT_TYPE, 2},
    {DB_TYPES_TABLE_ID, "type_name", TEXT_TYPE, 3}
};
}
